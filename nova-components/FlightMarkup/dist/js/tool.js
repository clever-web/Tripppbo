      ...
      return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return axios.get("/nova-vendor/flight-markup/airlines");

            case 2:
              resp = _context.sent;

              (_airlines = this.airlines).push.apply(_airlines, _toConsumableArray(resp.data));
...
var render = function() {
  ...
  return _c("div", [
    _c(
      "table",
      {
        staticClass: "border-collapse border border-gray-400",
