                ...
                <ul class="list-3">
                    <li>
                        <div class="d-flex align-items-center">
                            ...
                            <div><span class="gilroy-bold text-56d18f font-16" href="javascript:void(0)" >Mon 23 Aug</span></div>
                        </div>
                    </li>
                    <li>
                        <div class="d-flex">
                            <div class="mr-5">
                                ...
                                <p class="gilroy-medium font-12 mb-2">Nour Rajoub <i class="fas fa-check text-56d18f icon-14px ml-2"></i></p>
                                <p class="gilroy-medium font-12 mb-0">Joh Doe <i class="fas fa-check text-56d18f icon-14px ml-2"></i></p>
                            </div>
                            <div class="mr-5">
