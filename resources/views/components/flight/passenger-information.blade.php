    <section class="container-all-booking mb-3">
        ...
        <div class="text-center pt-0">
            <a href="javascript:void(0)" onclick="openTab(event, 'documents-and-passenger-2');" class="btn gilroy-bold text-fe2f70 text-decoration-underline font-12 p-0">Luggage Per Passenger</a>
        </div>
    </section>
