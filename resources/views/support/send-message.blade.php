            ...
            <div class="contact_center_box">
                ...
                <div class="contact_center_left">
                    <div class="contact_center_box_sm bg-white box_shadow mb-3">
                        ...
                        <h3 class="h6 text_dark_blue /img/ mb-1">Send an email</h3>
                        <p class="text_dark_blue fs_14 mb-4">Get in touch with our customer service team</p>
                        <a class="fs_14 text_pink text-decoration-none"
                            href="mailto:support@trippbo.com">support@trippbo.com</a>
                    </div>
                    <div class="contact_center_box_sm bg-white box_shadow mb-3">
                        <img class="mb-3" src="img/phone_i.svg" alt="">
                        <h3 class="h6 text_dark_blue /img/ mb-1">Call customer service</h3>
                ...
                <div class="contact_center_right">
                    <form  method="POST"  action="{{ route('support-create') }}" class="ajax contact_center_box_lg box_shadow pad__x mb-4">
                        <h3 class="h6 text_dark_blue mb-4">Still need help?</h3>
                        <div class="row gx-3 mt-1">
                            <div class="col-12 mb-3 d-flex"><img width="25" src="img/name.png" alt="">
                                <p class="ms-2 mb-0 text_dark_blue /img/">Name</p>
                            </div>
                            <div class="col-md-6 mb-3">
                                <input name="first_name" type="text" name="first_name"
                                    placeholder="Enter your first name"
                                    class="form-control input__gray fs_14 input_contact_center" id="input__gray_fname">
                            </div>
                            <div class="col-md-6 mb-3">
                                <input name="last_name" type="text" placeholder="Enter your last name"
                                    class="form-control input__gray fs_14 input_contact_center" id="input__gray_lname">
                            </div>
                        </div>
                        <div class="row gx-3 mt-2">
                            <div class="col-12 mb-3 d-flex"><img width="25" src="img/email_i.png" alt="">
                                <p class="ms-2 mb-0 text_dark_blue /img/">Email</p>
                            </div>
                            <div class="col-md-6">
                                <input name="email" type="email" placeholder="Enter your email address"
                                    class="form-control input__gray fs_14 input_contact_center" id="input__gray_email">
                            </div>
                        </div>
                        <div class="row gx-3 mt-4">
                            <div class="col-12 mb-3 d-flex"><img width="25" src="img/email_box.svg" alt="">
                                <p class="ms-2 mb-0 text_dark_blue /img/">Message</p>
                            </div>
                            <div class="col-12">
                                <textarea name="message" class="form-control input__gray input_review input_contact_center fs_14" id="special_request"
                                    rows="4" placeholder="Enter your message"></textarea>
                            </div>
                        </div>
                        <div class="mt-2">
                            <div class="g-recaptcha" class="mt-2" data-sitekey="{{ config('services.recaptcha.key') }}">
                            </div>
                        </div>
                        <div class="d-flex justify-content-center justify-content-lg-end mt-4">
                       
                            <button id="submit_button" type="submit" class="btn_contact_send /img/ btn_style">Send <img
                                    class="ms-3" src="img/send_i.svg" alt=""></button>
        ...
        $(document).on('submit', 'form.ajax', function() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#submit_button").val(
                        'We have Received Your Message And Will Come Back To You Shortly!');
                },
