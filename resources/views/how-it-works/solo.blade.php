                ...
                <div class="row_trip_white_box bg-white box_shadow border_radius_20 mb-4">
                    <!-- left -->
                        <div class="row_trip_white_box_left position-relative">
                            ...
                            <h3 class="h4 txt_blue_secondary fw_gilroy_medium">Create A Trip To Request A Fund</h3>
                    ...
                    <!-- right -->
                        <div class="row_trip_white_box_right">
                            <img class="w-100" src="/img/78345.png" alt="">
                        </div>
                </div>
            <!-- 2 -->
                <div class="row_trip_white_box row_trip_white_box2 bg-white box_shadow border_radius_20 mb-4">
                    <!-- right -->
                        <div class="row_trip_white_box_right">
                            <img src="/img/8dfsajf.png" alt="">
                        </div>
                    <!-- left -->
                        <div class="row_trip_white_box_left position-relative">
                            <div class="row_trip_white_box_left_after">2</div>
                            <h3 class="h4 txt_blue_secondary fw_gilroy_medium">Community Will Fund</h3>
                ...
                <div class="row_trip_white_box bg-white box_shadow border_radius_20 mb-4">
                    <!-- left -->
                        <div class="row_trip_white_box_left position-relative">
                            ...
                            <h3 class="h4 txt_blue_secondary fw_gilroy_medium">Fund Collected</h3>
