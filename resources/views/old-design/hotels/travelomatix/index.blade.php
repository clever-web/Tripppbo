            ...
            <div class="wrapper">
                    ...
                    <div class="col-sm-6 px-1 mb-2">
                        <div class="flex-grow-1">
                            ...
                            <div style="position:absolute;z-index: 13;background-color:white;">
                                <autocomplete-component @autocomplete_result_selected="selectHotelResult($event)"
                                    :keyword="hotelDestination"></autocomplete-component>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <aside id="aside" class="col-sm-12 col-lg-4">
                        ...
                        {{-- <h4 class="gilroy-medium font-22 mb-3">Payment type</h4>
                        <div class="mb-1"><label class="trippbo-checkbox gilroy-regular">Free cancellation<input
                                    type="checkbox" checked="checked" name="payment"/><span></span></label></div>
                        <div class="mb-4"><label class="trippbo-checkbox gilroy-regular">Reserve now, pay
                                later<input type="checkbox" name="payment"/><span></span></label></div>
                        <hr class="mb-4"/>
                        ...
                        <div class="mb-1"><label class="trippbo-radio gilroy-regular">Any<input type="radio"
                                                                                                checked="checked"
                                                                                                name="neighborhood"/><span></span></label>
                        </div>
        ...
        const sub_activity_app = new Vue({
            ...
            methods: {
                ...
                redirectToHotel: function(hotel) {
                    let url = '';
                    if (this.isPackage == '0') {
                        url = '/hotel/view?resultToken=' + hotel.ResultToken + '&tripId=' + this.tripId
                    } else {
                        url = '/hotel/view?resultToken=' + hotel.ResultToken + '&tripId=' + this.tripId
